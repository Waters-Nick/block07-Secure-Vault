...
- create string with message statement and combination. set string equal to secretMessage
...
let code1 = 2 + 7 + 1; // addition operation to generate first code. 2 + 7 = 9. 9 + 1 = 10.
let code2 = 5 * 10 - 10; //multiplication and subtraction operation to generate second code. 5 * 10 = 50. 50-10 = 40.
let code3 = 195 / 5; //division operation to generate third and final code. 195 / 5 = 39.
...
uses template literal to include space between secretMessage and the combination and then inserts the hyphens between each number.
*/
